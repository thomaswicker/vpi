<section class="superhero superhero-solutions">
	<img class="logo" src="<?php bloginfo( 'template_directory' ); ?>/svg/vpi-logo.svg" alt="VPI Logo">

	<?php get_template_part('partials/site-nav/site-nav-solutions'); ?>
	...
	<section class="superhero--right">
		<img class="sidebar-photo" src="<?php bloginfo( 'template_directory' ); ?>/img/hiking-photo.jpg" alt="Hiking Photo">

		<ul class="sidebar-nav">
			<li>
				<a href="/solutions">Planning</a>
			</li>

			<li>
				<a href="/solutions-investing">Investing</a>
			</li>

			<li class="active">
				<a href="/solutions-living">Living</a>
			</li>
		</ul>
	</section>
